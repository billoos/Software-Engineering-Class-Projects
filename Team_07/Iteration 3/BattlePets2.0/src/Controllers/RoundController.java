...
class RoundController {
    ...
    private void printPetInfo()
    {
        for(Playable participant:awakeParticipants) {
            ...
            IOManager.promptLine("HumanPet's type: " + participant.getPetType());
            IOManager.promptLine("HumanPet's HP: " + participant.getCurrentHp());
            IOManager.promptPartial("HumanPet's recharging skills:");
